...
char serialdata[15]={48,48,48,48,48,48,48,48,48,48,48,48,48,48,48};// initialize with all 0
...
void loop() {
int val1,val2,val3,val4,val5,val6,val7,val8,val9,val10,val11,val12,val13,val14,val15,lf = 10,i=0;
...
val6=(int)serialdata[5];
val7=(int)serialdata[6];
val8=(int)serialdata[7];
val9=(int)serialdata[8];
val10=(int)serialdata[9];
val11=(int)serialdata[10];
val12=(int)serialdata[11];
val13=(int)serialdata[12];
val14=(int)serialdata[13];
val15=(int)serialdata[14];
