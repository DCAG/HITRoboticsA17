...
$query = "SELECT * FROM __InstanceCreationEvent WITHIN 2 WHERE TargetInstance ISA 'Win32_SerialPort' AND TargetInstance.PNPDeviceID LIKE '%VID_{0}`&PID_{1}%'" -f '2341','0043'
